			...
			<form action="#" method="POST">
				<div class="form-group">
					<label for="name">Tên:</label> <input type="text" id="name"
						name="name" placeholder="Trần Minh Quân" required>
				</div>
				<div class="form-group">
					<label for="email">Email:</label> <input type="email" id="email"
						name="email" placeholder="vuiveluon@gmail.com" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="address">Địa chỉ:</label> <input type="text"
						...
						placeholder="155/11 Đường 8 khu phố 1 phường Gì đó quận Nào đây"
						required>
				</div>
				<div class="form-group">
