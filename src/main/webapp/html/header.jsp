<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    -->
				<div class="header">
					<a href="../index/index.jsp" class="logo_page"><img src="../image/general/logo.png" alt=""></a>
					...
					<div class="header_cart">
						<div class="header_cart_info">
							<a href="cart.jsp"> <img src="../image/home/cart.png" class="header_cart_logo" alt=""> <span
				...
				<div class="navigation">
					<div class="all_list">
						<i class="fa-solid fa-list all_list_logo"></i> <span class="all_list_text">Tất cả danh
							mục</span>
					</div>
				...
				<div class="modal_body_wishList">
					<div class="wishlist_header">
						...
						<h3 class="wishlist_title" style="margin-bottom: 0; margin-left: 12px;">Wishlist</h3>
