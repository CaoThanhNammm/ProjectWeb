...
<body>
	...
	<div class="header">
		...
		<div class="header_login_signin_mobile">
			<a href="login.jsp"><img src="../image/home/user.png"
				alt=""></a>
		</div>
	...
	<div class="navigation">
		...
		<ul class="navigtion-list">
			<li class="navigtion-item"><a href="product.jsp">Máy
					lọc nước</a></li>
			<li class="navigtion-item"><a href="product.jsp">Nồi
					chiên</a></li>
			<li class="navigtion-item"><a href="product.jsp">Bếp
					điện</a></li>
			<li class="navigtion-item"><a href="product.jsp">Nồi
					cơm</a></li>
			<li class="navigtion-item"><a href="product.jsp">Máy
			...
			<li class="navigtion-item"><a href="product.jsp">Bếp
					ga</a></li>
			<li class="navigtion-item"><a href="product.jsp">Bình
					đun</a></li>
		</ul>
		...
		<ul class="category_all_list">
			<div>
				...
				<ul class="category_all_item_child_list">
					<li><a href="product.jsp">Nồi chiên không dầu</a></li>
					<li><a href="product.jsp">Nồi cơm điện</a></li>
					<li><a href="product.jsp">Nồi áp suất</a></li>
					<li><a href="product.jsp">Nồi nấu chậm</a></li>
					<li><a href="product.jsp">Nồi, bộ nồi</a></li>
					<li><a href="product.jsp">Chảo chống dính</a></li>
					<li><a href="product.jsp">Bếp từ</a></li>
					<li><a href="product.jsp">Bếp gà</a></li>
					<li><a href="product.jsp">Bếp hồng ngoại</a></li>
					<li><a href="product.jsp">Lò vi sóng</a></li>
					<li><a href="product.jsp">Lò nướng</a></li>
					<li><a href="product.jsp">Lẩu điện</a></li>
				</ul>
			</div>
			...
			<div>
				...
				<ul class="category_all_item_child_list">
					<li><a href="product.jsp">Máy xay sinh tố</a></li>
					<li><a href="product.jsp">Máy ép trái cây</a></li>
					<li><a href="product.jsp">Máy ép chậm</a></li>
					<li><a href="product.jsp">Máy pha cà phê</a></li>
					<li><a href="product.jsp">Máy xay cà phê</a></li>
				</ul>
			</div>
			...
			<div>
				...
				<ul class="category_all_item_child_list">
					<li><a href="product.jsp">Bình đun siêu tốc</a></li>
					<li><a href="product.jsp">Bình thủy điện</a></li>
					<li><a href="product.jsp">Chén bát</a></li>
					<li><a href="product.jsp">dao, kéo</a></li>
					<li><a href="product.jsp">thớt</a></li>
				</ul>
			</div>
		</ul>
	</div>
	...
	<div class="modal_body_wishList">
		...
		<div class="wishlist_product_detail">
			<a href="wishlistDetail.jsp">XEM WISHLIST</a>
		</div>
	</div>
</body>
