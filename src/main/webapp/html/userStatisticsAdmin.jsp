					...
					<div class="col-lg-10">
						<div class="row">
							<div class="operating-systems">
								<span class="os1-os"> <span></span>Số lần được mua
								</span> <span class="os2-os"> <span></span>Giao thành công
								</span> <span class="os3-os"> <span></span>Tiếp cận sản phẩm mới
								</span>
							</div>
						</div>
						...
						<div class="row">
							<div class="chart">
								...
								<div class="svg-container">
									<svg width="100%" height="100%" class="data-chart"
										viewBox="0 0 563 204" xmlns="https://www.w3.org/2000/svg">
                                        <g fill="none"
											fill-rule="evenodd">
