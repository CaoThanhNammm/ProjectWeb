            ...
            <div class="row">
                <div class="col access_mb">
                    ...
                    <input type="hidden" name="access" value="login">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="access_group">
                                <div class="access_group_clause">
                                    Bằng cách tiếp tục, bạn đồng ý với <a class="color-yellow"
                                        href="policy.jsp" target="_blank">Điều khoản
                                        sử
                                        dụng</a>
                                    và <a class="color-yellow" href="policy.jsp" target="_blank">Thông báo
                                        quyền riêng tư</a> của N2Q.
                                </div>
                            </div>
                        ...
                        <div>
                            <h6>Chưa có tài khoản hãy <a class="color-yellow" href="register.jsp">Đăng ký ngay</a></h6>
                            <h6>Quên mật khẩu <a class="color-yellow" href="register.jsp">Tìm lại ngay</a></h6>
                        </div>
                    </form>
                </div>
