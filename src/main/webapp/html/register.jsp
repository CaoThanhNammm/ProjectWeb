<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<% String note=(String) session.getAttribute("status"); if (note !=null && !note.isBlank()) { switch (note) {
		case "success" : note="Đăng nhập thành công" ; break; case "failed-0" : note="Vui lòng kiểm tra lại thông tin" ;
		break; case "failed-1" : note="Email hoặc số điện thoại đã được đăng ký" ; break; default: note="Có lỗi" ;
		break; } } else { note="" ; } %>
				...
				<div id="register" class="container access">
					<div class="row">
						<div class="col access_mb">
							<form id="form_register" method="post" action="../access" accept-charset="UTF-8">
								...
								<div class="access_group">
									...
									<a href="../../../../index.jsp"> <img class="access_group_logo_img-black"
								...
								<div class="mt-4">
									<div class="access_group">
										<i class="fa-solid fa-user-tie access_group_icon"></i> <input id="name"
											type="text" placeholder="*Tên đăng nhập" maxlength="20" name="name"
											required>
									</div>
									<div class="access_group">
										<i class="fa-solid fa-phone access_group_icon"></i> <input type="number"
											placeholder="*Số điện thoại" name="phone" required>
									</div>
									<div class="access_group">
										<i class="fa-solid fa-envelope access_group_icon"></i> <input type="email"
											placeholder="*Địa chỉ email" name="email" required>
									</div>
									<div class="access_group">
										<i class="fa-solid fa-address-book access_group_icon"></i> <input type="text"
											placeholder="Địa chỉ" name="address">
									</div>
									<div class="access_group">
										<i class="fa-solid fa-calendar-days access_group_icon"></i> <input type="date"
											name="date" required>
									</div>
									<div class="access_group access_group_gender">
										<span>Giới tính:</span> <span><input name="gender" type="radio" value="male"
												checked>Nam</span> <span><input name="gender" type="radio"
												value="freeMale">Nữ</span> <span><input name="gender" type="radio"
												value="other">Khác</span>
									</div>
									<div class="access_group access_group_regulation">
										<i class="fa-solid fa-lock access_group_icon"></i> <input type="password"
											placeholder="*Mật khẩu" name="pass" minlength="6" required>
									</div>
									<div class="access_group">
										<i class="fa-solid fa-lock-open access_group_icon"></i> <input type="password"
											placeholder="*Nhập lại mật khẩu" name="rePass" minlength="6" required>
									</div>
